...
The main goal of |pe| library is to ease concurrent programming in Python by separating the specification of synchronization from the main logic aspect. Path expressions :cite:`campbell_specification_1974` and extensions :cite:`habermann_path_1975,campbell_path_1976,andler_predicate_1979,headington_open_1984,govindarajan_parc_1991,guo_synchronization_1994,heinlein_advanced_2003,zhao_sc-expressions_2007` are the selected theoretical framework to achieve this goal. In this setting the allowed paths of execution are specified declaratively by using constructions similar to regular expressions.
...
.. testcode:: with_process_register
