...
class Expression(ABC):
    ...
    get_eager_generator.__doc__ = f"""
        ...
        ``word_type`` is a :class:`~.CollectionWrapper` subtype that will be the type of collection to be used to represent words. Defaults to ``{WORD_TYPE.__name__}``.
    ...
    get_language.__doc__ = f"""
        ...
        ``language_type`` is a subtype of :class:`~.CollectionWrapper` that will be used as the type of the object to be returned, defaults to ``{LANGUAGE_TYPE.__name__}``.
