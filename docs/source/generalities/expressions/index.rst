...
For example, the expression :math:`(a|b)c`, generates sequences which two elements. The first element is either :math:`a` or :math:`b` and the second is :math:`c`. In |pe| idiom this may be expressed as:
